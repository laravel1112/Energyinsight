            ...
            angular.forEach(series, function(s) {
              ...
              if (chartSeries) {
                if (!angular.equals(prevSeriesOptions[s.id], chartOptionsWithoutEasyOptions(s))) {
                  chartSeries.update(_.clone(s), false);
                } else {
                  if (s.visible !== undefined && chartSeries.visible !== s.visible) {
                    chartSeries.setVisible(s.visible, false);
                  }
                  chartSeries.setData(_.clone(s.data), false);
                }
              } else {
                chart.addSeries(_.clone(s), false);
              }
            ...
            if (angular.isArray(newAxes)) {
              ...
              for (var axisIndex = 0; axisIndex < newAxes.length; axisIndex++) {
                ...
                if (axisIndex < chart[axisName].length) {
                  ...
                  updateZoom(chart[axisName][axisIndex], _.clone(axis));
                }
              ...
              updateZoom(chart[axisName][0], _.clone(newAxes));
            }
