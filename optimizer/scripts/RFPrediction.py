...
from optimizer.algorithm.optimizerbase import *

#from optimizer.algorithm.Prediction.RFFunctionSet import *
...
class RFPredictor(OptimizerBase):
    ...
    def Predictor(self,start_utc = None,end_utc = None,start_pre_utc = None,end_pre_utc = None ,freq = 'auto'):
            ...
            series_name = [EnergyUnit.objects.filter(id = self.objList[0])[0].influxKey]
            ...
            try:
                ...
                temp_datapoints = temp[0]['points']# check wether this will work
